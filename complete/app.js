...
function uploadMedia(event){
  ...
  const reader=new FileReader();reader.onload=()=>{if(!slot.isConnected)return;$(".media-preview",slot).src=reader.result;syncMediaSlot(slot);toast("Image added. Save Edits to keep it on this device.")};reader.readAsDataURL(file);
}
